...
$(function() {
  ...
  var current_year = 4;
  var current_kilovat = 25;
  var koeff_kilovat = 7000 / 40;
  var sum1;
  var sum2;

  var current_year_2 = 5;
  var current_kilovat_2 = 40;
  ...
  $(document).on('input', '.first_range', function(e) {
      first_output.innerHTML = e.currentTarget.value + " кВт";
      current_kilovat = e.currentTarget.value;


      sum1 = Math.round(current_kilovat * (koeff_kilovat * current_year));

      second_out.innerHTML = '€ ' + sum1;

      sum2 = Math.round(750 * current_kilovat);

      first_out.innerHTML = '€ ' + sum2;
  });

  $(document).on('input', '.second_range', function(e) {
      second_output.innerHTML = e.currentTarget.value;
      current_year = e.currentTarget.value;
  ...
  $(document).on('input', '.third_range', function(e) {
      third_output.innerHTML = e.currentTarget.value + " кВт";
      current_kilovat_2 = e.currentTarget.value;
      sum1 = Math.round((7000 * current_year_2) * (current_kilovat_2 / 40));

      four_out.innerHTML = '€ ' + sum1;

      sum2 = Math.round(current_kilovat_2 * 750);

      third_out.innerHTML = '€ ' + sum2;
  });

  $(document).on('input', '.four_range', function(e) {
      four_output.innerHTML = e.currentTarget.value;
      current_year_2 = e.currentTarget.value;
